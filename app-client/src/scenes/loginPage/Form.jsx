...
const Form = () => {
    ...
    const register = async (values, onSubmitProps) => {
        ...
        formData.append('picturPath', values.picture.name);
            ...
            {({
                ...
                <form onSubmit={handleSubmit}>
                                ...
                                <Box gridColumn="span 4" border={`1px solid ${palette.neutral.medium}`}>
                                    <Dropzone acceptedFiles=".jpg,.jpeg,.png" multiple={false} onDrop={(acceptedFiles) => setFieldValue("picture", acceptedFiles[0])}>
                                        {({ getRootProps, getInputProps }) => (
                                            <Box {...getRootProps()}
                                                border={`2px dashed ${palette.primary.main}`} p="1rem" sx={{ "&:hover": { cursor: "pointer" } }}>
                                                <input {...getInputProps()} />
                    ...
                    <Box>
                        ...
                        >
                            {isLogin ? "Don't have an acocunt? Sign Up here" : "Already have an account? Login Here"}
                        </Typography>
